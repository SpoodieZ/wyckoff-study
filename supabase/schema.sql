...
-- Tự tạo 1 dòng profiles (role mặc định 'viewer') mỗi khi có user mới trong auth.users
...
-- Ai cũng đọc được nhật ký (kể cả role viewer) — quyền xem là mở cho mọi người đã đăng nhập.
