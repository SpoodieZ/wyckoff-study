...
export default function DailyChallengeCard() {
  ...
  return (
    <Link
      href="/daily"
      className="group relative flex items-center justify-between gap-4 overflow-hidden rounded-frame bg-gradient-to-r from-primary to-primary-strong px-5 py-4 shadow-study transition-transform hover:scale-[1.01] md:px-8"
    >
      <span className="absolute right-4 top-3 rounded-full bg-crimson px-2.5 py-0.5 text-caption font-bold uppercase tracking-wide text-on-primary">
        Hôm nay
      </span>
